...
<head>
    ...
    <title>About - Nathaniel Larrimore</title>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-md-3">
                    <img class="img-responsive img-border-left" src="me.JPG" alt="nathaniel larrimore">
                </div>
                <div class="col-md-9">
					...
					but I chose to move to New York to study Computing and Infomation Technologies.</p>
                </div>
            </div>
        </div>
    </div>
